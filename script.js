...
var QUESTS = [
    ...
    },
    {
        ...
        options: [
            { text: "А) Стив Джобс (Стратег и управленец)", cat: "mgmt" },
    ...
    },
    {
        ...
        options: [
            { text: "А) Создание фонда благотворительности из прибылей", cat: "mgmt" },
    ...
    },
    {
        ...
        options: [
            ...
            { text: "В) Идейным лидером в сфере технологий", cat: "creativ" },
